"""
CrewOps Agent Prompt Definitions.

All prompts are ChatPromptTemplates stored as module-level constants.
This allows them to be imported by both the notebook and test suites.
"""
