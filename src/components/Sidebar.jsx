    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 h-20 border-b border-white/[0.06] shrink-0">
        <div className="w-10 h-10 flex items-center justify-center relative group">
          ...
          <img src="/logo_nobg.png" alt="CrewOps Logo" className="w-full h-full object-contain relative z-10" />
        </div>
        <div>
          <span className="text-sm font-black text-slate-100 uppercase tracking-widest">CrewOps</span>
