      ...
      <header className="relative space-y-6">
        <div className="flex items-center justify-between print:hidden">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              <img src="/logo_nobg.png" alt="CrewOps Logo" className="w-6 h-6 object-contain" />
              <span className="text-[10px] font-black text-slate-100 uppercase tracking-widest">CrewOps Docs</span>
            </div>
          </div>
          <button 
            onClick={handlePrint}
        ...
        <div className="pt-8">
          ...
          <p className="text-xl text-slate-500 max-w-2xl mt-4 leading-relaxed print:text-slate-700">
            A comprehensive breakdown of the CrewOps autonomous agent pipeline, state management, and deployment protocols.
          </p>
        </div>
      </header>
      ...
      <section className="space-y-10">
        ...
        <div className="glass rounded-[2.5rem] p-10 border-white/[0.04] grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <h3 className="text-xl font-bold text-slate-200 tracking-tight">The CrewOpsState</h3>
          ...
          <div className="bg-black/20 rounded-3xl p-8 border border-white/[0.04] font-mono text-[11px] text-rose-400/80 print:text-slate-900 print:border-slate-300">
            <pre className="custom-scrollbar overflow-x-auto">{`class CrewOpsState(TypedDict):
    raw_logs: str
    log_summary: str
    severity: str
    ...
    notifications: Annotated[list, add]`}</pre>
      ...
      <footer className="pt-20 border-t border-white/[0.06] text-center space-y-4">
        <p className="text-slate-600 text-xs font-mono uppercase tracking-[0.4em]">
          End of Specification • CrewOps Autonomous Systems
        </p>
        <div className="hidden print:block text-slate-400 text-[10px]">
          © 2026 CrewOps Engineering • Technical Whitepaper v1.0.0
        </div>
      </footer>
