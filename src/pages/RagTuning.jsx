...
export default function RagTuning() {
  ...
  const handleExport = () => {
    ...
    downloadAnchorNode.setAttribute("download", "crewops_config.json");
  ...
  return (
    <div ref={containerRef} className="space-y-8 pb-16">
      ...
      <div className="animate-in">
        ...
        <p className="text-sm text-slate-400 mt-1">Fine-tune every parameter in the CrewOps pipeline for maximum precision and performance</p>
      </div>
